...
<style>
  ...
  .stack-card li strong { color: var(--text-primary); }
</style>
...
<div class="hero">
  ...
  <div class="social-links" style="margin-bottom: 2rem; justify-content: center; gap: 2.5rem; display: flex;">
    ...
    <a href="https://www.youtube.com/@y4ty0" target="_blank" title="YouTube" class="hero-social-link">
      <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
    </a>
  </div>
...
<section style="margin: 4rem auto; max-width: 1000px; padding: 0 1rem;">
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(260px, 1fr)); gap: 1.5rem;">
    <div class="stack-card">
      <h3>🔍 Disciplinas OSINT</h3>
      <ul>
        <li><strong>IMINT / GEOINT</strong> — Geolocalización por imágenes y análisis de terreno.</li>
        <li><strong>SOCMINT</strong> — Análisis e investigación en redes sociales y perfiles digitales.</li>
        <li><strong>CTI</strong> — Inteligencia de Amenazas y análisis de infraestructura.</li>
      </ul>
    </div>
    <div class="stack-card">
      <h3>🛠️ Herramientas & Búsqueda</h3>
      <ul>
        <li><strong>Búsqueda Avanzada</strong> — Google Dorks y operadores booleanos avanzados.</li>
        <li><strong>Reconocimiento</strong> — Shodan, Maltego, Whois histórico y DNS.</li>
