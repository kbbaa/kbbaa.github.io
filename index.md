        ...
        {% for post in site.posts limit:3 %}
          <div class="carousel-slide">
            <div class="carousel-card">
              <span class="carousel-date">{{ post.date | date: "%d/%m/%Y" }}</span>
              ...
              <a href="{{ post.url | relative_url }}" class="btn-primary" style="margin-top: 1.5rem;">Leer investigación</a>
            </div>
          </div>
        {% endfor %}
      </div>
    ...
    <div class="carousel-wrapper">
      <div class="carousel-track" id="carouselTrack">
        {% if site.posts.size > 0 %}
          {% assign carousel_posts = site.posts | slice: 0, 3 %}
